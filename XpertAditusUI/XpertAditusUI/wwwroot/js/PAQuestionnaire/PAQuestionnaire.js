...
function getPAQuestionnaire(TrainingContentId) {
    ...
    var url = window.location.origin + '/PATest/GetActiveTestInfo?CourseId=' + window.CourseId + '&TrainingContentId=' + TrainingContentId + '&monthytestid=' + window.MonthlyTestId.toString();
    $.ajax({
        url: url,
        type: 'GET',
        success: function (result) {
