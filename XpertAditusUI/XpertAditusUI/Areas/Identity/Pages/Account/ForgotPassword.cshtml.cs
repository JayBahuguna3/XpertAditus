...
namespace XpertAditusUI.Areas.Identity.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<IdentityUser> userManager, IEmailSender emailSender, UtilityService utilityService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                _utilityService.SendMailForForgotPassword(Input.Email, "Reset Password", body);
