        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        if (await _userManager.IsInRoleAsync(user, "College"))
                        {
                            TempData["Pws"] = Input.Password;
                            return LocalRedirect("/CollegeDashBoard/CollegeDashBoard");
                        }
                        ...
                        {
                            var userInfo = _userProfileService.GetUserInfo(user.Id);
                            var IsProfileComplete = _userProfileService.IsProfileComplete(userInfo.UserProfileId);
                            ...
                            {
                                return LocalRedirect("/userprofile");
                            }
                        }
